...
public class PdfGenerator {
    ...
    private final static Logger log = Logger.getLogger(PdfGenerator.class);
    ...
    private static PeripheryVote getPeripheryVote(int line, HashMap<Committee, HashMap<Integer, Candidate>> mapCandidate, List<String[]> listAllFieldInFile) {
        ...
        correspondenceVoting.setIssuedPackages(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_IssuedPackages));
        correspondenceVoting.setReceivedReplyEnvelopes(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_ReceivedReplyEnvelopes));
        correspondenceVoting.setMissingStatement(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_MissingStatement));
        correspondenceVoting.setMissingSignatureOnStatement(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_MissingSignatureOnStatement));
        correspondenceVoting.setMissingEnvelopeForVotingCard(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_MissingEnvelopeForVotingCard));
        correspondenceVoting.setUnsealedEnvelope(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_UnsealedEnvelope));
        correspondenceVoting.setEnvelopesThrownToBallotBox(getLongFromCsv(listAllFieldInFile, line, PdfGenerator.INDEX_EnvelopesThrownToBallotBox));
    ...
    private static List<PeripheryVote> loadPeripheryVotesFromCsv(String fileName) {
        ...
        try {
            reader = new CSVReader(new InputStreamReader(PdfGenerator.class.getResourceAsStream(fileName)), ',', '\"');
